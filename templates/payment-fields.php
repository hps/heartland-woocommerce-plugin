                        ...
                        <?php foreach ($cards as $i => $card): ?>
                           ...
                           <?php endforeach; ?>
                              ...
                              <div class="saved-card">
                                 <div class="saved-card-selector">
                                    <input type="radio" id="new_card" name="secure_submit_card" style="width:auto;" <?php checked(1, 1); ?> value="new" /></div>
                                 <div class="saved-card-info">
               ...
               <div class="securesubmit-content">
                  <div class="securesubmit_new_card">
                     <div class="securesubmit_new_card_info">
                        ...
                        <div class="form-row form-row-wide no-bottom-margin no-bottom-padding">
                           <label for="securesubmit_card_number">
                              <?php _e("Credit Card number", 'wc_securesubmit') ?> <span class="required">*</span></label>
                        ...
                        <div class="form-row">
                           <div class="form-row-first half-row">
                              <label for="securesubmit_card_expiration">
                                 <?php _e("Expiration date", 'wc_securesubmit') ?> <span class="required">*</span></label>
                              <?php if ($this->use_iframes): ?>
                           ...
                           <div class="form-row-last half-row">
                              <label for="securesubmit_card_cvv">
                                 <?php _e("Security code", 'wc_securesubmit') ?> <span class="required">*</span></label>
                              <?php if ($this->use_iframes): ?>
                     ...
                     <?php if ($this->allow_card_saving == 'yes'): ?>
                        <div class="form-row form-row-wide no-top-margin no-top-padding no-bottom-padding no-bottom-margin">
