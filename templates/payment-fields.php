   ...
   <div class="securesubmit-content">
      <div class="securesubmit_new_card">
         <div class="securesubmit_new_card_info">
            ...
            <div class="form-row form-row-wide no-bottom-margin no-bottom-padding hideable" style="display:none;">
            ...
            <div class="clear"></div>
            <div class="form-row hideable" style="display:none;">
         ...
         <?php if ($this->allow_card_saving == 'yes'): ?>
            <div class="form-row form-row-wide no-top-margin no-top-padding no-bottom-paddig no-bottom-margin">
               <p class="form-row form-row-wide securesubmit-save-cards" style="display:none;">
