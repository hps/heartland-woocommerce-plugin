...
class WC_Gateway_SecureSubmit_MasterPass_Capture
{
    ...
    public function call($order)
    {
        try {
            ...
            if ($masterpassPaymentStatus === 'captured') {
                throw new Exception(__('Transaction has already been captured', 'wc_securesubmit'));
            }
    ...
    {
        $actions[$this->id . '_capture'] = __('Capture MasterPass authorization', 'wc_securesubmit');
        return $actions;
    }
}
